...
class TestAddUser(BaseTest):
    def test_should_see_success_after_add_user(self):
        ...
        result = TesterResponse.from_json(TesterClient.post_to_ws(body=user))
    ...
    def test_should_see_failed_after_add_user_by_existing_user(self):
        ...
        another_result = TesterResponse.from_json(TesterClient.post_to_ws(body=user))

        assert another_expected_result == another_result
